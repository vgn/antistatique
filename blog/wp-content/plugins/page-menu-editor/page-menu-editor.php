...
class PageMenuEditor {
	...
	function plugin_update() {
		...
		if (empty($theversion) || version_compare($theversion, '2.1.1') == -1) :
			...
			update_option('dsa_pme_version', '2.1.1');
		endif;
	}
...
<?php
	...
	function pme_update($id) {
		...
		update_post_meta($id, 'dsa_pagemenueditor', $pme_detail);
	}
	...
	function options() {
	    ...
	    than enough. Alternatively you can browse my
	    <a href="http://www.amazon.co.uk/gp/registry/21YINXNYKPGSJ">Amazon Wishlist</a> or just make a donation to
	    my holiday fund via PayPal.</p>
