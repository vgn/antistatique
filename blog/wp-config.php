 ...
 * @since 2.6.0
 */
define('AUTH_KEY', 'Vive les carottes magenta!');
define('SECURE_AUTH_KEY', 'et la double crème de Gruyère');
define('LOGGED_IN_KEY', 'ainsi que le cafe cool');
define('NONCE_KEY', 'mais le toute ne fait pas un savant mélange...');
/**#@-*/
